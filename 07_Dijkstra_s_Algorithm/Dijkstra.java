...
class Graph 
{
	...
	void shortestPath(int src) 
    {
		...
		while (!pq.isEmpty()) 
		{
			...
			PriorityQueue<iPair> tempPQ = new PriorityQueue<>(pq); // Creating a temporary copy of the priority queue
			while (!tempPQ.isEmpty()) 
			{
				iPair pair = tempPQ.poll();
				System.out.println("Vertex: " + pair.second + ", Distance: " + pair.first);
			}
			System.out.println("..........");
